...
from .views import ArtistListView,ArtistCreateView,ArtistUpdateView,ArtistDeleteView,ArtistDetailView,MusicCreateView,MusicDeleteView,MusicUpdateView,export_to_csv
...
urlpatterns = [
    ...
    path("artist/import_csv/",export_to_csv,name="artist_import_csv"),
